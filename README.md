...
| [`python-cheat-sheet-stdlib.md`](python-cheat-sheet-stdlib.md) | Standard library | File & console I/O (text/binary, append, standard streams), command-line arguments (`sys.argv`, `argparse`), environment variables — more sections coming: JSON, Base64, hashing, datetime, regex, random, collections, subprocess, logging, itertools, csv | [PDF](pdf/python-cheat-sheet-stdlib.pdf) |
