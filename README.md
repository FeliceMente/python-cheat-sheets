...
| [`python-cheat-sheet-stdlib.md`](python-cheat-sheet-stdlib.md) | Standard library | File & console I/O (text/binary, append, standard streams), command-line arguments (`sys.argv`, `argparse`), environment variables, JSON, Base64, hashing & secrets, datetime, regular expressions, random — more sections coming: collections, subprocess, logging, itertools, csv | [PDF](pdf/python-cheat-sheet-stdlib.pdf) |
